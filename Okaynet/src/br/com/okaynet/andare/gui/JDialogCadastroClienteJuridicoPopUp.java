 ...
 * @author Erick
 */
public class JDialogCadastroClienteJuridicoPopUp extends javax.swing.JDialog {

    /**
     * Creates new form JDialogCadastroCliente
     */
    public JDialogCadastroClienteJuridicoPopUp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        preencher();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldRazao, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 190, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogCadastroClienteJuridicoPopUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogCadastroClienteJuridicoPopUp dialog = new JDialogCadastroClienteJuridicoPopUp(new javax.swing.JFrame(), true);
    ...
    private void preencher() {
        if (Data.hash.get("clienteJuridico") == null) {
            JOptionPane.showMessageDialog(this, "Aconteceu um problema ao obter os dados.");
        } else {
            if (Data.hash.get("clienteJuridico") instanceof ClienteJuridico) {
                ClienteJuridico cliente = (ClienteJuridico) Data.hash.get("clienteJuridico");
                Data.hash.remove("clienteJuridico");
                if (cliente == null) {
                    JOptionPane.showMessageDialog(this, "Aconteceu um problema ao obter os dados.");
                } else {
                    jTextFieldCod.setText(String.valueOf(cliente.getId()));
                    jTextFieldRazao.setText(cliente.getRazaoSocial());
                    jTextFieldEstadual.setText(cliente.getInscricao());
                    ...
                    jTextFieldResponsavel.setText(cliente.getResponsavel());
