 ...
 * @author Erick
 */
public class JDialogCadastroFuncionarioPopUp extends javax.swing.JDialog {

    /**
     * Creates new form JDialogCadastroClienteFisico
     */
    public JDialogCadastroFuncionarioPopUp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        preencher();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogCadastroFuncionarioPopUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogCadastroFuncionarioPopUp dialog = new JDialogCadastroFuncionarioPopUp(new javax.swing.JFrame(), true);
        ...
        if (Data.hash.get("funcionario") == null) {
            ...
            if (Data.hash.get("funcionario") instanceof Funcionario) {
                ...
                if (funcionario == null) {
                    ...
                    jTextFieldEndereco.setText(funcionario.getEndereco().getLogradouro());
                    jFormattedTextFieldTelefone1.setText(funcionario.getEndereco().getTelefone1());
                    jFormattedTextFieldTelefone2.setText(funcionario.getEndereco().getTelefone2());
                    jFormattedTextFieldTelefone3.setText(funcionario.getEndereco().getTelefone3());


                    jFormattedTextFieldNumero.setText(String.valueOf(funcionario.getEndereco().getNumero()));
                    ...
                    jFormattedTextFieldDataNascimento.setText(Util.calendarToString(funcionario.getNascimento()));
                    jTextFieldDataCadastro.setText(Util.calendarToString(funcionario.getDataCadastro()));

                    jTextFieldEmail.setText(funcionario.getEmail());

                    jComboBoxTipoLogradouro.setSelectedItem(funcionario.getEndereco().getTipoLogradouro());
                    jComboBoxCidade.setSelectedItem(funcionario.getEndereco().getCidade());
                }
    ...
    private void salvar() {
        if (validaCamposEmBranco()) {
            ...
            funcionario.setId(Integer.parseInt(jTextFieldCod.getText()));
            funcionario.setCpf(jFormattedTextFieldCpf.getText());
            funcionario.setDataCadastro(Util.stringToCalendar(jTextFieldDataCadastro.getText()));
            funcionario.setEmail(jTextFieldEmail.getText());

            funcionario.setNascimento(Util.stringToCalendar(jFormattedTextFieldDataNascimento.getText()));
